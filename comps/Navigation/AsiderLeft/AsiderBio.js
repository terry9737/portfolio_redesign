const AsiderBio = () => {
  return (
    <section>
      <div className="flex flex-col space-y-5 border-b-2 border-gray-400 pb-7">
        <span className="flex justify-between">
          <p className="px-2 py-1 sm:px-3 sm:py-1 bg-header-yellow text-header-black font-light">
            Age:
          </p>
