      ...
      <Container>
        <div className="flex flex-col sm:flex-row items-center justify-center py-7 overflow-hidden shadow-md">
          <div className="flex flex-col items-start justify-center">
            ...
            <span className="px-5">
              <a href="mailto:adriangorgos@gmail.com">
                <button className="uppercase px-8 py-4 rounded-md bg-header-yellow mt-8 z-20 hover:bg-dark-cta transition-colors duration-300 hover:text-dark-ctaText">
                  hire me
                </button>
              </a>
            </span>
